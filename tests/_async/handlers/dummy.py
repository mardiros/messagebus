...
@async_listen
async def handler(
    command: DummyCommand, uow: AsyncAbstractUnitOfWork[Any, Any, Any]
): ...


@async_listen
async def handler_evt1(
    command: DummyEvent, uow: AsyncAbstractUnitOfWork[Any, Any, Any]
): ...


@async_listen
async def handler_evt2(
    command: DummyEvent, uow: AsyncAbstractUnitOfWork[Any, Any, Any]
): ...
